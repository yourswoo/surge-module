#!/usr/bin/env python3
"""Build the Towngas Scripting package with stored ZIP entries."""
...
OUTPUT = BASE.parent / "towngas-widget.scripting"
FILES = ("index.tsx", "widget.tsx", "towngas-api.ts", "boxjs.ts", "script.json")
...
def build_package() -> None:
    ...
    for filename in FILES:
        ...
        central_header = struct.pack(
            ...
            dos_time, dos_date, crc, len(data), len(data), len(name),
            0, 0, 0, 0, 0o644 << 16, offset,
        ) + name
